<div class="modal fade" id="modal-update-element">
    <form action="{{ route('service.content.update') }}" method="post" id="form-update-slider" class="modal-dialog" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <textarea name="content1" id="content1" class="form-control ckeditor" cols="30" rows="15"></textarea>
            </div>   
