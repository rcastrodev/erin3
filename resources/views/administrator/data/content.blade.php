...
<div class="card card-primary">
    ...
    <form action="{{ route('data.content.update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <input type="text" name="youtube" value="{{$data->youtube}}" class="form-control" placeholder="Link del canal de Linkedin">
            </div>
            <div class="form-group">
                <input type="text" name="text_footer" value="{{$data->text_footer}}" class="form-control" placeholder="Texto del footer">
            </div>
