...
@section('content_header')
    <div class="d-flex">
        ...
        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-create-element">crear marca</button>
    </div>
@stop
@section('content')
<div class="row mb-5">
...
@section('css')
    ...
    <meta name="content_find" content="{{route('brand.content.find')}}">
